...
.venv\Scripts\python.exe -u run_ai_gate.py --gold XAUUSD --silver XAGUSD --model asheparte_ai_v9_shadow.joblib --signal-file aurum_guard_ai_signal.csv --history-file asheparte_ai_v9_forward_log.csv --max-equity-drawdown-percent 2.0
exit /b %errorlevel%
